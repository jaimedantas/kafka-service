...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1310882721802937566L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"com.jaimedantas\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}");
   ...
   */
  public static com.jaimedantas.Payment.Builder newBuilder() {
    return new com.jaimedantas.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.jaimedantas.Payment.Builder newBuilder(com.jaimedantas.Payment.Builder other) {
    return new com.jaimedantas.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.jaimedantas.Payment.Builder newBuilder(com.jaimedantas.Payment other) {
    return new com.jaimedantas.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jaimedantas.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jaimedantas.Payment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jaimedantas.Payment.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jaimedantas.Payment.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jaimedantas.Payment.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jaimedantas.Payment.Builder clearAmount() {
